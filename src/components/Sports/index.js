...
function Sports({getpopular,getsearchimgdata,getdata,getrecommendations,getsimilarimage}){
   ...
   const [ratings_from_child,get_ratings]=useState([])
    ...
    useEffect(()=>{
        ...
        axios({
            method: 'get',
            // url: 'https://recommender-fyp.herokuapp.com/sports/getpopular',
            url:getpopular,
          })
          ...
          axios({
            method: 'get',
            // url: 'https://recommender-fyp.herokuapp.com/sports/getsearchimgdata',
          ...
          axios({
            method: 'get',
            // url: 'https://recommender-fyp.herokuapp.com/sports/getdata',
            url:getdata,
          })
          .then((response)=>{ 
    ...
    const Clicked = () =>{
        ...
        axios({
            ...
            method: 'post',
            // url: 'https://recommender-fyp.herokuapp.com/sports/getrecommendations',
    ...
    const productClicked = (e) =>{
        ...
        axios({
            method: 'post',
            // url: 'https://recommender-fyp.herokuapp.com/sports/getsimilarimage',
            url:getsimilarimage,
            data: 
                {
